...
export const CATEGORIES: Category[] = [
  ...
  },
  {
    ...
    fns: [
      ...
      { name: 'Solve', syntax: 'Solve[c, vars]', examples: ['Solve[2*x == 6, x]'], desc: t('Alias of FindInstance for equations; the solution is returned as exact rules {x -> …}.', 'Alias de FindInstance pour les équations ; la solution est rendue en règles exactes {x -> …}.', '方程式向けの FindInstance の別名。解は厳密な規則 {x -> …} で返される。') },
